        ...
        <div className="relative w-full max-w-screen-lg">
            ...
            <EditorRoot>
                <EditorContent
                    ...
                    className="relative min-h-[200px] w-full max-w-screen-lg border-muted bg-background sm:mb-[calc(8vh)] sm:rounded-lg sm:border sm:shadow-lg"
                    editorProps={{
                        handleDOMEvents: {
                            keydown: (_view, event) =>
